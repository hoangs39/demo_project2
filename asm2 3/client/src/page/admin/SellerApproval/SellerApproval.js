...
const SellerApproval = ({ showToast }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      allSellers = await getSellers();
    } catch (err) {
      showToast("Can't get sellers !");
    }
    if (allSellers) {
                  ...
                  <td colSpan={2}>
                    <button
                      ...
                      onClick={() => {
                        ...
                        showToast("Sucessfully Approved Account!");
                      }}
                    >
                      <FontAwesomeIcon
                        icon={faCheckCircle}
